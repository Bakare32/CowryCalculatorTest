...
class GraphViewLayout: UIView {
    
    let dummyData = [DummyGraphData(date: "2022-10-19", rate: 9148.61), DummyGraphData(date: "2022-10-20", rate: 13868.01), DummyGraphData(date: "2022-10-21", rate: 24872.84), DummyGraphData(date: "2022-10-22", rate: 26073.66), DummyGraphData(date: "2022-10-23", rate: 17146.98), DummyGraphData(date: "2022-10-26", rate: 17628.37), DummyGraphData(date: "2022-10-27", rate: 1765.75), DummyGraphData(date: "2022-10-28", rate: 4824.44), DummyGraphData(date: "2022-10-29", rate: 883.08), DummyGraphData(date: "2022-10-30", rate: 19192.02), DummyGraphData(date: "2022-11-02", rate: 50622.18), DummyGraphData(date: "2022-11-02", rate: 50622.18), DummyGraphData(date: "2022-11-03", rate: 50568.06), DummyGraphData(date: "2022-11-04", rate: 39054.38), DummyGraphData(date: "2022-11-05", rate: 31795.59), DummyGraphData(date: "2022-11-06", rate: 73234.34), DummyGraphData(date: "2022-11-09", rate: 29391.93), DummyGraphData(date: "2022-11-10", rate: 37044.78), DummyGraphData(date: "2022-11-11", rate: 36399.55), DummyGraphData(date: "2022-11-12", rate: 49595.65), DummyGraphData(date: "2022-11-13", rate: 54156.04), DummyGraphData(date: "2022-11-16", rate: 48727.86), DummyGraphData(date: "2022-11-17", rate: 69688.61), DummyGraphData(date: "2022-11-18", rate: 57707.39)]
    ...
    private func blankValueFormatter() -> AxisValueFormatter {
        class blankIAxisValueFormatter: AxisValueFormatter {
